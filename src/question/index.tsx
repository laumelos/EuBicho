...
function Question() {
  ...
  const [pointsData, setPointsData] = useState<Animal[]>([
    ...
    { animal: "raposa", points: 0, name: "Raposa", image: "raposa.png", text:"A raposa é astuta e adaptável, famosa por sua esperteza e inteligência. Ela se destaca por sua capacidade de se camuflar em diversos ambientes e é um excelente caçador noturno. Com seu focinho afiado e orelhas grandes, a raposa é tanto charmosa quanto habilidosa." },
    { animal: "papagaio", points: 0, name: "Papagaio", image: "papagaio.png", text:"O papagaio é vibrante e sociável, conhecido por suas cores brilhantes e habilidades impressionantes de imitar sons. Ele é extremamente inteligente e gosta de interagir com os humanos, muitas vezes se tornando o centro das atenções com suas “conversas” divertidas." },
    { animal: "tartaruga", points: 0, name: "Tartaruga", image: "tartaruga.png", text:"Lentas mas determinadas, as tartarugas são símbolos de persistência e longevidade. Com suas cascas protetoras e uma vida longa, elas viajam pelo tempo com calma e sabedoria, sempre mantendo um ritmo constante em suas jornadas." },
    { animal: "coruja", points: 0, name: "Coruja", image: "coruja.png", text:"Mistérios da noite, as corujas são conhecidas por sua visão aguçada e capacidade de voar em silêncio. Símbolos de sabedoria e vigilância, elas caçam com precisão e têm um jeito encantador de girar a cabeça em quase 360 graus." },
    { animal: "camaleao", points: 0, name: "Camaleão", image: "camaleao.png", text:"Mestres da camuflagem, os camaleões mudam de cor para se adaptar ao ambiente e mostrar emoções. Com olhos que se movem independentemente, eles têm uma visão panorâmica e uma língua rápida como um foguete para capturar insetos." },
    { animal: "panda", points: 0, name: "Panda", image: "panda.png", text:"Os pandas são conhecidos por seu charme e pelagem preta e branca. Embora passem a maior parte do tempo comendo bambu, são excelentes escaladores e têm um comportamento brincalhão. Eles têm uma personalidade tranquila e adorável." },
    { animal: "capivara", points: 0, name: "Capivara", image: "capivara.png", text:"A capivara é o maior roedor do mundo e tem um jeito sociável e relaxado. Adora água e passa muito tempo nadando e socializando com seus amigos. São animais gentis e amigáveis, sempre prontos para um banho de sol." },
    { animal: "lhama", points: 0, name: "Lhama", image: "lhama.png", text:"A lhama é uma criatura carinhosa e muito expressiva, conhecida por seu charme e suas caretas engraçadas. Ela é super sociável e adora estar com a sua manada. Além de serem ótimas para carregar cargas, elas também têm um talento especial para spitting!" },
    { animal: "preguica", points: 0, name: "Bicho-preguiça", image: "preguica.png", text:"O bicho-preguiça é o mestre da calma, passando a maior parte do tempo pendurado de cabeça para baixo nas árvores. Seu ritmo lento é uma forma de economizar energia, e ele só desce para o chão uma vez por semana. Seus movimentos são tão lentos que até as algas crescem em seu pelo!" },
    { animal: "golfinho", points: 0, name: "Golfinho", image: "golfinho.png", text:"Amigáveis e inteligentes, os golfinhos são conhecidos por suas habilidades acrobáticas e sua comunicação complexa. Eles formam laços fortes dentro de seus grupos e têm um comportamento social rico. Além disso, são capazes de resolver problemas e usar ferramentas." },
    { animal: "lontra", points: 0, name: "Lontra", image: "lontra.png", text:"Divertidas e sociais, as lontras são excelentes nadadoras e usam ferramentas, como pedras, para abrir moluscos. Elas formam laços fortes com suas famílias e passam muito tempo brincando e caçando em grupos. Com uma pelagem densa, elas se mantêm aquecidas mesmo em águas frias." },
    { animal: "pinguim", points: 0, name: "Pinguim", image: "pinguim.png", text:"Os pinguins são mestres da natação e passam a maior parte do tempo no mar. Em terra, eles caminham com uma marcha engraçada e formam colônias grandes para se proteger do frio. São leais e cuidam bem de seus filhotes em um ambiente desafiador." },
  ]);
  ...
  return (
    <div className="h-screen max-h-screen flex flex-col items-center bg-zinc-950 justify-between p-8 space-y-8 md:space-y-16 mdLandscape:space-y-10 smallLandscape:space-y-8 overflow-y-auto portrait:overflow-y-auto landscape:overflow-hidden">
